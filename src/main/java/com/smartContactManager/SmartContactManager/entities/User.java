...
public class User {
    ...
    // @Pattern(regexp = "^(?=.*[0-9])(?=.*[!@#$%^&*()_+\\-=[\\]{};':\"\\\\|,.<>/?]).{8,}$", message = "Password must start with a capital letter, contain at least one number, one special character, and be at least 8 characters long")
